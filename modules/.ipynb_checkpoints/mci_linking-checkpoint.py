...
def link_neurobat(df_long, DATA_DIR):
    """
    df_long - a main table with longitudinal examinations for all subjects belonging to one of our predefined groups.
    DATA_DIR - a global variable, with path to folder with all csv files.
